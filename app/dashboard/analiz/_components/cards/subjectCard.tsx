...
export default function SubjectCard({ icon: Icon, subject }: SubjectCardProps) {
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <SubjectDetailModal subject={subjectPerformanceData[0]} />
        </div>
      </CardHeader>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="text-center p-3 bg-green-100 dark:bg-green-900/20 rounded-lg">
            <div className="text-xl font-bold text-green-800 dark:text-green-200">
              {formatNumber(subject.stats.best)}
            </div>
          ...
          <div className="text-center p-3 bg-blue-100 dark:bg-blue-900/20 rounded-lg">
            <div className="text-xl font-bold text-blue-600">
              {formatNumber(subject.stats.average)}
            </div>
          ...
          <div className="text-center p-3 bg-red-100 dark:bg-red-900/20 rounded-lg">
            <div className="text-xl font-bold text-red-600 dark:text-red-400">
              {formatNumber(subject.stats.worst)}
            </div>
